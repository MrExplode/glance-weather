...
dependencies {
    ...
    implementation(group = "gg.jte",                name = "jte",                  version = "3.1.16")
    jteGenerate   (group = "gg.jte",                name = "jte-native-resources", version = "3.1.16")
    runtimeOnly   (group = "ch.qos.logback",        name = "logback-classic",      version = "1.5.17")
